...
\newcommand{\VarTituloTesis}{Aquí va el Título de la tesis}
\newcommand{\VarAutorUno}{Nombres y Apellidos 1}
\newcommand{\VarAutorDos}{Nombres y Apellidos 2} % Dejar en blanco para un solo autor
\newcommand{\VarGrado}{Ingeniero en Telecomunicaciones}
\newcommand{\VarAsesor}{Dr. Nombres y Apellidos}
